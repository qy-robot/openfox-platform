...
This is the RoboCoding product fork of [New API](https://github.com/QuantumNous/new-api). Repository: `qy-robot/robocodingai-platform`; product branch: `robo/main`. The original upstream `main` branch is preserved.
...
- The separate RoboCoding desktop uses DSH Desktop; the upstream `electron/` directory is not our chosen App implementation.
