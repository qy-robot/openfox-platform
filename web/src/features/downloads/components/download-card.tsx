...
export function DownloadCard(props: { target: DownloadTarget }) {
  ...
  return (
    <Card className='border-border/60 bg-card/75 relative min-h-60 overflow-hidden shadow-[0_18px_55px_-38px_rgba(37,99,235,0.55)] backdrop-blur'>
      <div
        aria-hidden='true'
      ...
      <CardHeader className='gap-3 pt-2'>
        <div className='flex size-11 items-center justify-center rounded-xl border border-blue-500/15 bg-blue-500/8 text-blue-600 dark:text-blue-400'>
