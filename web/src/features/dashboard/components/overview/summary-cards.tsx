  ...
  return (
    <div className='bg-card overflow-hidden rounded-2xl border'>
      <div className='grid xl:grid-cols-[minmax(0,1fr)_21rem]'>
        ...
        <div className='flex flex-col justify-between gap-4 border-t bg-[#e8f4f8]/55 p-5 sm:p-7 xl:border-t-0 xl:border-l dark:bg-[#19364d]/55'>
          <div className='flex flex-col gap-2 sm:gap-3'>
            ...
            <div className='grid grid-cols-2 gap-2'>
              <div className='bg-background/60 rounded-lg px-3 py-3'>
                ...
                <div className='text-foreground mt-2 truncate text-base font-semibold tabular-nums'>
